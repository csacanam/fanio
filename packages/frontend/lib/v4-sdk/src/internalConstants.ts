...
export const OPEN_DELTA = BigInt(0)

// default prices - simple sqrt ratio calculation
export const SQRT_PRICE_1_1 = JSBI.BigInt('79228162514264337593543950336') // sqrt(1/1) * 2^96
