...
export abstract class SwapRouter {
  ...
  public static swapCallParameters(
    ...
    return SwapRouter.encodePlan(planner, nativeCurrencyValue, {
      deadline: options.deadlineOrPreviousBlockhash ? BigInt(options.deadlineOrPreviousBlockhash) : undefined,
    })
  }
  ...
  public static migrateV3ToV4CallParameters(
    ...
    return SwapRouter.encodePlan(planner, BigInt(0), {
      deadline: BigInt(options.v4AddLiquidityOptions.deadline),
    })
  }
